...
public class BankAccountRestAPI {
    ...
    public DebitDTO debit(@RequestBody DebitDTO debitDTO) throws BankAccountNotFoundException, BalanceAccountInsufficientException {
    ...
    public void transfer(@RequestBody TransferRequestDTO transferRequestDTO) throws BankAccountNotFoundException, BalanceAccountInsufficientException {
